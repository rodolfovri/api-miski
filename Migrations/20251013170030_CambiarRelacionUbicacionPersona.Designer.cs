...
namespace Miski.Api.Migrations
{
    ...
    [Migration("20251013170030_CambiarRelacionUbicacionPersona")]
    partial class CambiarRelacionUbicacionPersona
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Miski.Domain.Entities.Ubicacion", b =>
                {
                    b.HasOne("Miski.Domain.Entities.Usuario", "Usuario")
                        .WithOne("Ubicacion")
                        .HasForeignKey("Miski.Domain.Entities.Ubicacion", "IdUsuario")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_Ubicacion_Usuario");

                    b.HasOne("Miski.Domain.Entities.Persona", null)
