...
namespace Miski.Api.Migrations
{
    ...
    [Migration("20251021064349_CambiarRelacionNegociacionVariedadProducto")]
    partial class CambiarRelacionNegociacionVariedadProducto
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Miski.Domain.Entities.Negociacion", b =>
                {
                    ...
                    b.Property<string>("PrimeraEvindenciaFoto")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.Property<string>("SegundaEvindenciaFoto")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.Property<string>("TerceraEvindenciaFoto")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
