...
public class ProductosController : ControllerBase
{
    ...
    /// </summary>
    [HttpGet]
    public async Task<ActionResult<ApiResponse<IEnumerable<object>>>> GetProductos(
    ...
    /// </summary>
    [HttpGet("{id}")]
    public async Task<ActionResult<ApiResponse<object>>> GetProductoById(
        int id,
        CancellationToken cancellationToken = default)
    {
        try
    ...
    /// </summary>
    [HttpPost]
    public async Task<ActionResult<ApiResponse<object>>> CreateProducto(
    ...
    /// </summary>
    [HttpPut("{id}")]
    public async Task<ActionResult<ApiResponse<object>>> UpdateProducto(
        int id,
        [FromBody] object request,
        CancellationToken cancellationToken = default)
    {
    ...
    /// </summary>
    [HttpGet("{id}/stock")]
    public async Task<ActionResult<ApiResponse<IEnumerable<object>>>> GetStockByProducto(
        int id,
        CancellationToken cancellationToken = default)
    {
        try
