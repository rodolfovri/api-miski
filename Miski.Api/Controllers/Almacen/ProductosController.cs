...
public class ProductosController : ControllerBase
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            return BadRequest(ApiResponse<ProductoDto>.ValidationErrorResult(ex.Errors));
        }
        catch (Shared.Exceptions.NotFoundException ex)
        {
            return NotFound(ApiResponse<ProductoDto>.ErrorResult(
    ...
    /// </summary>
    /// <remarks>
    /// NOTA: No se puede eliminar un producto que tiene stock asociado o negociaciones activas.
    /// </remarks>
    [HttpDelete("{id}")]
