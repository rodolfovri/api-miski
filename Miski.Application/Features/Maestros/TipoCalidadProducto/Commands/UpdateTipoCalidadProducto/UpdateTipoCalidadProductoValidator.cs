...
public class UpdateTipoCalidadProductoValidator : AbstractValidator<UpdateTipoCalidadProductoCommand>
{
    public UpdateTipoCalidadProductoValidator()
    {
        RuleFor(x => x.TipoCalidadProducto.IdTipoCalidadProducto)
            .GreaterThan(0)
            .WithMessage("El ID del tipo de calidad es requerido");
